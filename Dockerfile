...
RUN apk add --no-cache --virtual .build-deps curl && \
    ...
    curl -sL https://downloads.sourceforge.net/project/freepascal/Linux/$FPC_VERSION/fpc-$FPC_VERSION-$FPC_ARCH.tar | tar -x -C /tmp/fpc-$FPC_VERSION-$FPC_ARCH --strip-components=1 && \
